...
<div className="services-grid">
  ...
  <article className="service-card reveal-card">
    ...
    <div className="service-card-image">
      <img
        src="/images/services/IT_technician_1.jpg"
  ...
  <article className="service-card reveal-card">
    ...
    <div className="service-card-image">
      <img
        src="/images/services/Technology2.jpg"
  ...
  <article className="service-card reveal-card">
    ...
    <div className="service-card-image">
      <img
        src="/images/services/Technology3.jpg"
        alt="Cloud & Microsoft 365"
      />
    </div>
  ...
  <article className="service-card reveal-card">
    ...
    <div className="service-card-image">
      <img
        src="/images/services/Technology1.jpg"
        alt="Networking & Wi-Fi"
      />
    </div>
  ...
  <article className="service-card reveal-card">
    ...
    <div className="service-card-image">
      <img
        src="/images/services/ServerRepair1.jpg"
        alt="Servers, Storage & Virtualization"
      />
    </div>
  ...
  <article className="service-card reveal-card">
    ...
    <div className="service-card-image">
      <img
        src="/images/services/ServerRepair2.jpg"
